...
BottomNavigationBarThemeData(
  ...
  unselectedIconTheme: IconThemeData(color: _lightColorScheme.secondary),
  selectedLabelStyle:
  _lightTextTheme().bodySmall?.copyWith(fontWeight: FontWeight.w700),
  unselectedLabelStyle:
  _lightTextTheme().labelMedium?.copyWith(fontWeight: FontWeight.w500),
);
...
BottomNavigationBarThemeData(
    ...
    type: BottomNavigationBarType.fixed,
    backgroundColor: _darkColorScheme.onSecondary,
    unselectedItemColor: _darkColorScheme.primary,
    selectedIconTheme: const IconThemeData(color: GreenLight),
    unselectedIconTheme: IconThemeData(color: _darkColorScheme.primary),
    selectedLabelStyle:
    _darkTextTheme().bodySmall?.copyWith(fontWeight: FontWeight.w700),
    unselectedLabelStyle: _darkTextTheme()
        .labelMedium
